---
title: "Pheno.AI Expanded Knowledge Base"
---

# Welcome to the Expanded Knowledge Base

This is the expanded version of the Pheno.AI Knowledge Base. You can customize this content as needed.
...
Start adding your content here. You can:

- Add new pages by creating `.qmd` or `.md` files
- Update the `_quarto.yml` to add them to the navigation
